...
class OlympResult(QWidget):
    ...
    def update_table(self):
            ...
            if len(login_parts) >= 4:
                ...
                if school_match and class_match:
                    ...
                    if '-' in place_str:
                        ...
                        place_max = place_min
                    filtered_data.append((score, place_min, place_max, last_name))
        ...
        for i, (score, place_min, place_max, last_name) in enumerate(filtered_data):
            self.tableWidget.setItem(i, 0, QTableWidgetItem(last_name))
            self.tableWidget.setItem(i, 1, QTableWidgetItem(str(score)))
