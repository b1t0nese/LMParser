...
## Формат ввода
В первой строке входных данных задаётся l. 46N — число сортов мороженого. Каждая из последующих l. 46N строк состоит из названия сорта и отделённой от него табуляцией целочисленной цены. Далее всегда следует строка-разделитель: «------------------------». После неё начинается перечень заказов, каждая строка которого либо пуста (если она разделяет заказы), либо состоит из названия сорта и количества порций с табуляцией между ними. Наконец, в последней строке, обозначающей конец ввода, записана одна точка.
...
**Полученный балл:** 13  
**Статус:** accepted  
**Дата:** 2025-12-14T13:03:04.977057+03:00  
**Контест:** 4774  
**Вердикт:** ok  